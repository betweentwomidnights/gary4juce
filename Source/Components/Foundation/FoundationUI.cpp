...
void FoundationUI::paint(juce::Graphics&)
{}

void FoundationUI::resized()
{
...
void FoundationUI::setVisibleForTab(bool visible)
{
    setVisible(visible);
}

void FoundationUI::setTitleVisible(bool visible)
{
    titleLabel.setVisible(visible);
    titleHidden = !visible;
}

juce::StringArray FoundationUI::getSelectedBehaviorTags() const
{
...
int FoundationUI::getSeed() const
{
...
void FoundationUI::setIsStandalone(bool standalone)
{
    isStandaloneMode = standalone;
    updateContentLayout();
}

void FoundationUI::setFamily(const juce::String& family)
{
...
void FoundationUI::setSubfamily(const juce::String& sub)
{
...
void FoundationUI::setGenerateButtonEnabled(bool enabled, bool isGenerating)
{
    generateButton.setEnabled(enabled && !isGenerating);
    generateButton.setButtonText(isGenerating ? "generating..." : "generate");
}

void FoundationUI::setGenerateButtonText(const juce::String& text)
{
    generateButton.setButtonText(text);
}

void FoundationUI::setInfoText(const juce::String& text)
{
    infoLabel.setText(text, juce::dontSendNotification);
}

void FoundationUI::setAdvancedOpen(bool open)
{
...
void FoundationUI::refreshDurationInfo()
{
    updateBpmDisplay();
...
juce::String FoundationUI::serializeState() const
{
...
void FoundationUI::restoreState(const juce::String& jsonString)
{
...
void FoundationUI::applyRandomizeResponse(const juce::var& response)
{
...
void FoundationUI::clearToggleGroup(juce::OwnedArray<CustomButton>& buttons)
{
...
void FoundationUI::setToggleByLabel(juce::OwnedArray<CustomButton>& buttons, const juce::String& label)
{
    for (auto* btn : buttons)
...
void FoundationUI::layoutFlowButtons(juce::OwnedArray<CustomButton>& buttons, int startX, int maxX, int& y)
{
...
void FoundationUI::layoutKnobsForPair(bool leftOn, SteppedKnob* leftA, SteppedKnob* leftB, bool leftBVis,
...
void FoundationUI::setupSingleKnobToggle(CustomButton& toggle, SteppedKnob& knob,
...
void FoundationUI::setupDualKnobToggle(CustomButton& toggle, SteppedKnob& knobA, SteppedKnob& knobB,
...
void FoundationUI::setupComboBox(CustomComboBox& combo, const juce::StringArray& items, const juce::String& tooltip)
{
    combo.clear();
...
void FoundationUI::setupToggleGroup(juce::OwnedArray<CustomButton>& buttons,
...
void FoundationUI::addDescriptorExtraRow(const juce::String& text)
{
...
void FoundationUI::removeDescriptorExtraRow(int index)
{
...
void FoundationUI::clearDescriptorExtraRows()
{
    for (auto& row : descriptorExtraRows)
    {
        if (row.text) { row.text->setVisible(false); contentComponent->removeChildComponent(row.text.get()); }
...
juce::StringArray FoundationUI::getDescriptorsExtraInternal() const
{
...
void FoundationUI::updateSubfamilyOptions()
{
...
void FoundationUI::updateBpmDisplay()
{
...
void FoundationUI::updateBpmWarning()
{
    int foundationBpm = getFoundationBpm();
...
void FoundationUI::rebuildPromptPreview()
{
...
void FoundationUI::randomizeControls()
{
...
void FoundationUI::updateContentLayout()
{
