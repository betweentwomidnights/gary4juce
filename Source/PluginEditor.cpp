...

{
    ...
    jerryTabButton.setButtonStyle(CustomButton::ButtonStyle::Inactive); // Start inactive
    ...
    undoTransformButton.setCustomColors(juce::Colours::darkorange, juce::Colours::white);
    ...
    playOutputButton.setButtonStyle(CustomButton::ButtonStyle::Jerry); // Green for play
    ...
    stopOutputButton.setButtonStyle(CustomButton::ButtonStyle::Inactive); // Gray for stop
...
{
    // Update tab button appearances using custom button styles
...
void Gary4juceAudioProcessorEditor::styleLoopTypeButton(CustomButton& button, bool selected)
{
    ...
    if (selected)
    {
        ...
        button.setCustomColors(juce::Colours::orange, juce::Colours::black);
    }
    else
    {
        // Unselected state - darker to contrast with selected
        button.setCustomColors(juce::Colour(0x50, 0x50, 0x50), juce::Colours::lightgrey);
    }
}
